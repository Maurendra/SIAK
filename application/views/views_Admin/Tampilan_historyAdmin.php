									...
									<table class="table table-striped table-bordered table-hover" id="dataTables-example">
										...
										<tbody>
											...
											<tr>
												...
												<td>
												<a href="<?php echo site_url('c_admin/showEditSurat/'.$key->ID);?>"><button class="btn-primary">Edit</button></a>
												<a href="<?php echo site_url('c_admin/deleteFixSurat/'.$key->ID);?>"><button class="btn-danger">Delete</button></a>
												</td>
											</tr>
											<?php } ?>
										</tbody>
